...
export default function Poster({ post }: Props) {
        ...
        >
          ...
          <label className="block mb-5">
            ...
            <input
              ...
              className="shadow-sm border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500  outline-none focus:ring"
              type="text"
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              className="shadow-sm border rounded py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500  outline-none focus:ring"
              rows={8}
